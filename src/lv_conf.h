 ...
 *and LV_DITHER_ERROR_DIFFUSION = 1 implies LV_DRAW_COMPLEX = 1 (gradient drawing support)*/
#define LV_DITHER_GRADIENT 0
#if LV_DITHER_GRADIENT
    /*Add support for error diffusion dithering.
     *Error diffusion dithering gets a much better visual result, but implies a much slower rendering*/
 ...
 *If LV_USE_ASSERT_NULL is enabled, and NULL pointer is passed to a function
 *it will halt the MCU*/
...
#define LV_FONT_MONTSERRAT_14 1  // 默认字体，确定可用
...
#define LV_FONT_MONTSERRAT_48 1  // 大字体用于主数字显示

/*Demonstrate special features*/
#define LV_FONT_MONTSERRAT_12_SUBPX      0
#define LV_FONT_MONTSERRAT_28_COMPRESSED 0  /*bpp = 3*/
#define LV_FONT_DEJAVU_16_PERSIAN_HEBREW 0  /*Hebrew, Arabic, Perisan letters and all their forms*/
#define LV_FONT_SIMSUN_16_CJK            1  /*1000 most common CJK radicals - 启用中文支持*/
